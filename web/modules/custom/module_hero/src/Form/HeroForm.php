...
class HeroForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $winner = rand(1,2);
    Drupal::messenger()->addMessage('The winner between ' . $form_state->getValue('rival_1') . ' and ' . $form_state->getValue('rival_2') . 'is: ' . $form_state->getValue('rival_' . $winner));
  }
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    } elseif (empty($form_state->getValue('rival_2'))) {
      $form_state->setErrorByName('rival_1', $this->t('Please specify rival two.'));
    }
  }
